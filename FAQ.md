...
Any regex match simply indicates yet another trace/behavior present in the PS command. By combining those with anomaly detecion and general data analytics strategies (grouping, scoring, etc), the regular expressions are very powerful.

---

### 3. Why not creating Sigma rules instead?

There are multiple reaons here. Below a few highlights:
